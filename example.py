...
def home():
    ...
    body = Body(modules=[header, content])
    page = Page(title='Viper!', body=body, stylesheets=['https://www.w3schools.com/w3css/4/w3.css', 'https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css'])
    print(page.source())
    return page.source()
